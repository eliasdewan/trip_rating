...
export const aroundLondonOutcodes: OutcodeData = {
  ...
  "HA4": { TFLZone: 5, congestionZone: false, directionFromLondon: "NW", distanceFromLondon: 10.0, areaName: "North West London", localityName: "Harefield" },
  ...
  "TW3": { TFLZone: 5, congestionZone: false, directionFromLondon: "W", distanceFromLondon: 12.0, areaName: "West London", localityName: "Hounslow" },
  "TW4": { TFLZone: 5, congestionZone: false, directionFromLondon: "W", distanceFromLondon: 12.5, areaName: "West London", localityName: "Hounslow" },
  "TW5": { TFLZone: 5, congestionZone: false, directionFromLondon: "W", distanceFromLondon: 13.0, areaName: "West London", localityName: "Heston" },
  "TW7": { TFLZone: 5, congestionZone: false, directionFromLondon: "W", distanceFromLondon: 11.0, areaName: "West London", localityName: "Isleworth" },
